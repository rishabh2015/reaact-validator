export var errorStrings = {
    ...
    maxCharatersError: function (maxLength) {
        if (maxLength === void 0) { maxLength = 50; }
        return "Please enter upto " + maxLength + " characters only";
    },
    eAppsExportLimitError: "You have completely utilized your maximum limit of CV Access. Please check your Account Utilization section for details or request your Super-User to release more quota using Manage Quota interface.",
    technicalIssueError: "Due to some technical issue, your request could not be processed. Please try again in a few minutes.",
    ...
    alertLimitExceeded: "Auto search agent limit exceeded. Please remove some to nominate others to get alerts. However, by doing this your search agent will not be deleted.",
